...
{
    /// <summary>
    /// 寄貨事件 (Delivery_CargoDynamics_02)
    /// </summary>
    public class Delivery_CargoDynamics_02 : Query
    {
        public CargoDynamics02Args? Args { get; set; } = null;
    }

    public class CargoDynamics02Args
    {
