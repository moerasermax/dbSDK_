...
namespace CPF.Service.MongoElastic.UnitTest
{
    public class ElasticTest
    {
        ...
        public ElasticTest()
        {
            ...
            _Repo = new OrderRepository_Elastic(new ElasticDriver("Elastic", settings), new ElasticMap());
        ...
        public async Task Test_Mongo_Insert_Logic()
        {
            ...
            if (Request != null)
            {
                ...
                exceptResult = string.Format("[{0}]",await Do(response));
            }
